...
static TRANSPORT_TYPE GetTransportType(TransportType transportType)
{
    ...
    case TransportType::RAW:
        return TT_MP4_RAW;
        break;
    case TransportType::ADIF:
        return TT_MP4_ADIF;
        break;
    case TransportType::ADTS:
        return TT_MP4_ADTS;
        break;
    case TransportType::LATM_MPC1:
        return TT_MP4_LATM_MCP1;
        break;
    case TransportType::LATM_MPC0:
        return TT_MP4_LATM_MCP0;
        break;
    case TransportType::LOAS:
        return TT_MP4_LOAS;
        break;
    default:
...
static AUDIO_OBJECT_TYPE GetAudioObjectType(AudioObjectType aot)
{
    switch (aot)
    {
    case AudioObjectType::AAC_LC:
        return AOT_AAC_LC;
        break;
    case AudioObjectType::AAC_HE:
        return AOT_SBR;
        break;
    case AudioObjectType::AAC_HE_V2:
        return AOT_PS;
        break;
    case AudioObjectType::AAC_LD:
        return AOT_ER_AAC_LD;
        break;
    case AudioObjectType::AAC_ELD:
...
static AudioObjectType FromAudioObjectType(AUDIO_OBJECT_TYPE aot)
{
    ...
    {
    case AOT_AAC_LC:
        return AudioObjectType::AAC_LC;
    case AOT_SBR:
        return AudioObjectType::AAC_HE;
    case AOT_PS:
        return AudioObjectType::AAC_HE_V2;
    case AOT_ER_AAC_LD:
        return AudioObjectType::AAC_LD;
    case AOT_ER_AAC_ELD:
        return AudioObjectType::AAC_ELD;
    default:
        throw std::runtime_error("Unknown AOT");
    }
}
...
{
    switch ((SampleRate)rate)
    {
    case SampleRate::R96000:
        return 0;
    case SampleRate::R88200:
        return 1;
    case SampleRate::R64000:
        return 2;
    ...
    case SampleRate::R32000:
        return 5;
    case SampleRate::R24000:
        return 6;
    case SampleRate::R22050:
        return 7;
    case SampleRate::R16000:
        return 8;
    case SampleRate::R12000:
        return 9;
    case SampleRate::R11025:
        return 10;
    case SampleRate::R8000:
        return 11;
    case SampleRate::R7350:
        return 12;
    default:
        return rate;
    }
...
static int GetChannelOrder(ChannelOrder order)
{
    switch (order)
    {
    case ChannelOrder::MPEG:
        return 0;
    case ChannelOrder::WAV:
        return 1;
    default:
